...
Mermaid ERD with only primary keys and foreign keys.
...
erDiagram
    ...
    Association {
        string AssociationKey PK
    }

    Caravan {
        string CaravanKey PK
    }

    CaravanStop {
        string CaravanStopKey PK
    }
    ...
    MemberStateLicense {
        string MemberStateLicenseKey PK
    }
    ...
    OfficeCorporateLicense {
        string OfficeCorporateLicenseKey PK
    }
    ...
    ShowingAppointment {
        string ShowingAppointmentKey PK
    }

    ShowingAvailability {
        string ShowingAvailabilityKey PK
    }

    ShowingRequest {
        string ShowingRequestKey PK
    }

    SocialMedia {
        string SocialMediaKey PK
    }
